...
| --- | --- | --- | --- | --- |
| ICP | [Felix Immobilien](https://www.felix-immobilien.de/ueber-uns.html) · Partner, die Multi-Agents verkaufen · siehe [fonio.ai](https://www.fonio.ai/industry-use-cases/hausverwaltungen) |  | Tierarztpraxen  [Filu](https://www.filu.vet/) · Haben bereits viele HI-Agents (25) · Vong Volumen her: [Sanimed](https://www.sanimed.de/) · 7 - 30 HI-Agents | Digitales Rechnungs- Management  [Invoice Fetcher](https://www.invoicefetcher.com/de/) · Viele Calls, aber nicht nicht annähernd ausreichend MA (8 Menschen, betreuen 17k Kundenaccounts ) · Klassische CX-Lösung für sie nicht kaufbar |
...
## Stärken/Schwächen Wettbewerber

|  | fonio.ai |  |  | Parloa | Ist vgl mit Cognigy |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Position | "Intelligenter Anrufbeantworter" ist praktisch das technisch machbare (solange Sie die PBX nicht mitliefern) | "Telefonsekretariat" wird verkauft |  | "AI Contact Center" zusätzlich zum Contact Center | Sidenote: "Salesfoce Sales Chef ist jetzt Parloa Sales Chef" · "Conversational Brain" |  |  |  |
| Growth | 100k Umsatz | Pareto: Top 240 Kunden machen 80k | Growth ca. 80 Kunden / Monat | 120 Mio cäsh inne täsch |  | ca 30 Mio Jahresumsatz |  |  |
| Kunden | 13/calls/day/customer | Die meisten Kunden haben ein Volumen einer "Zentrale" |  | S4 · Scheinen "Downmarket" zu gehen |  |  |  |  |
| Growth Strategy | 250 Affiliates · 10 Anfragen pro Tag | Sales Led |  | Sales-Led |  |  |  |  |
| Strength | Self Service | Social Media / "Startupflair" / Transparenz | DSGVO / AIact Kommunikation | Brand | Integrationen | Multi-Channel | "Sicherheit" · Für uns "neu" | Datenschutz |
| Weakness | Nur AB | Keine "eigene Netze" | Gebootstraped (noch) | Nur Projekt Integration/SetUp |  |  |  |  |
...
- Weekly Mittwochs um 13 - 14 Uhr R-AI-segruppe
...
![image-3458764634188411032](https://api.miro.com/v2/boards/uXjVJfuNUIY%3D/resources/images/3458764516994584783?format=preview&redirect=false)
...
- Neuen Markt erschließen (Innovatoren unter Inhouse-Service-Manager)
...
- Das Contact Center für AI- und HI Agenten

## Copy of AI Frontdesk – Zielgruppe und Value Proposition

| Control Panel | **HI/AI.CX** |
| --- | --- |
| AI Agents |  |
| Qualitätsmanagement AI Agents |  |
| HI-AI-Kollaboration |  |
...
![image-3458764634190485885](https://api.miro.com/v2/boards/uXjVJfuNUIY%3D/resources/images/3458764516326570767?format=preview&redirect=false)

## Copy of AI Frontdesk – Zielgruppe und Value Proposition

Umsatz und Upsellpfade

- Aktuell für uns nicht erreichbare Kunden

- Frontdesk Standalone

- Upsellversprechen: HI/AI-Kollaboration

![image-3458764634191415933](https://api.miro.com/v2/boards/uXjVJfuNUIY%3D/resources/images/3458764516326570767?format=preview&redirect=false)

- Upsell PBX-Bestandskunden
...
## Produkt Prinzipien \[WIP\]

|  |  |  |  | Produkt Prinzipien [WIP] |  |  |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  | Und so wollen wir handeln und entscheiden |  |  |  |
| **Migration hat Vorrang** | **Qualität Tech vor Workarounds** | **Lernen durch Exploration** |  | **Handeln schlägt Perfektion.** | **Speed over Perfection.** | **Zusammenarbeit in Reisegruppen** |
| Die Migration der NeoPBX hat Priorität. Die Arbeit der beteiligten Teams wird nicht unterbrochen. | Wir machen Produkt-Experimente ab sofort auf einer stabilen, skalierbaren Plattform – und nutzen dabei unsere AI-Features ganz ohne Abkürzungen sauber und durchdacht ein. | Wir wissen noch nicht, welche ai-Produkte sich durchsetzen. Deshalb experimentieren und recherchieren wir aktiv. |  | Eine gute, pragmatische Entscheidung ist besser als gar keine oder zu lange abgewartete perfekte.  Damit wir schnell Handlungsfähig sind. | Eine gute, pragmatische Entscheidung ist besser als gar keine oder zu lange abgewartete perfekte.  Damit wir schnell Handlungsfähig sind. | Reisegruppen fördern Zusammenarbeit, schaffen radikale Transparenz und sichern klare Ergebnisverantwortung. |
| **Kund:innen entscheiden** | **Schnelligkeit im AI-Markt als ein First Mover** | **Differenzierung durch HI/AI- Zusammenarbeit** |  | **Keep it simple. ** | **Flexibel im Inhalt, klar im Kurs.** | **Kopieren ist erlaubt.** |
| Jede Minute kann von AI oder Human Intelligence übernommen werden – Kund:innen entscheiden, was besser ist. (Keine technische Entscheidung.) | Möglichst schnell, möglichst viele AI-Produkte ins sipgate-Portfolio bringen und an Kund:innen verkaufen. | Unser Hebel liegt in der Zusammenarbeit zwischen Human und AI. Im Zweifel entscheiden wir uns eher dafür als dagegen. |  | Einfache Wege sind besser als komplexe | Wir passen unsere Themen und Lösungen an,  ohne unseren Modus oder unsere Ausrichtung zu verlieren. | Im Early Stage zählt Geschwindigkeit. Wir übernehmen, was funktioniert – und verbessern es, wo es sinnvoll ist. |

![image-3458764634207889952](https://api.miro.com/v2/boards/uXjVJfuNUIY%3D/resources/images/3458764516995166880?format=preview&redirect=false)
...
![image-3458764634761419930](https://api.miro.com/v2/boards/uXjVJfuNUIY%3D/resources/images/3458764517010374990?format=preview&redirect=false)
...
- Kevin und Robin identifizieren gemeinsame Needs aus Frontdesk und CX-Sicht
...
- Kurzes Update aus den Reisegruppen
...
![image-3458764639318666692](https://api.miro.com/v2/boards/uXjVJfuNUIY%3D/resources/images/3458764517143859883?format=preview&redirect=false)
...
- Am Channel, damit auch User Zugriff auf das Wissen haben
